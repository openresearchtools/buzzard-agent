...
export const nativeServiceManagerRefs: Readonly<Record<NativeServiceId, NativeServiceManagerRef>> = {
  sessiond: {
    systemdName: "wildbuzzard-agent-sessiond.service",
    launchdLabel: "org.wildbuzzard.agent.sessiond",
    launchdPlistName: "org.wildbuzzard.agent.sessiond.plist",
    logName: "sessiond.log",
  },
  web: {
    systemdName: "wildbuzzard-agent-web.service",
    launchdLabel: "org.wildbuzzard.agent.web",
    launchdPlistName: "org.wildbuzzard.agent.web.plist",
    logName: "web.log",
  },
  uiDev: {
    systemdName: "wildbuzzard-agent-ui-dev.service",
    launchdLabel: "org.wildbuzzard.agent.ui-dev",
    launchdPlistName: "org.wildbuzzard.agent.ui-dev.plist",
    logName: "ui-dev.log",
  },
};
