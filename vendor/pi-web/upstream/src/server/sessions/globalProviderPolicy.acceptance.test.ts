...
describe("immutable global provider bootstrap acceptance", () => {
  it("loads global config and native providers once, then treats normal session replay as a no-op", async () => {
    ...
    expect(logEntries).toContainEqual({
      level: "info",
      details: { context: "global-provider-bootstrap", providerIds: ["global-config", "global-native", "llama.cpp"] },
    ...
    expect(runtime.getRegisteredProviderIds()).toEqual(["global-config", "global-native", "llama.cpp"]);
